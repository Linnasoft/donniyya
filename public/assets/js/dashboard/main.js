! function(e) {
    ...
    t.on("load", function() {
        ...
        e(o).delay("500").fadeOut(2e3), a.on("click", ".side-menu-wrap .side-menu-ul>li>a .btn-toggle", function() {
            ...
            opens: "right",
            singleDatePicker: !0
        }), a.on("click", ".input-number-increment", function() {
            var t = e(this).parents(".input-number-group").find(".input-number"),
                a = parseInt(t.val(), 10);
            t.val(a + 1)
        }), a.on("click", ".input-number-decrement", function() {
            var t = e(this).parents(".input-number-group").find(".input-number"),
                a = parseInt(t.val(), 10);
            t.val(a - 1)
        ...
        }), e("#amount").val("$" + e("#slider-range").slider("values", 0) + " - $" + e("#slider-range").slider("values", 1)), e(h).length && e(h).chosen({
