<!---------  --------->
<div id="successfully_logged_notification" data-status="{{ (session('successfully_logged_notification')? session('successfully_logged_notification'): '') }}"></div> 

<div id="successfully_logged_out_notification" data-status="{{ (session('successfully_logged_out_notification')? session('successfully_logged_out_notification'): '') }}"></div> 
<!---------  --------->
                    ...
                    <div class="col-lg-12">
                        <div class="menu-full-width">
                                            ...
                                            <div class="">
                                                ...
                                                <div class="dropdown-item">
                                                    <a class="dropdown-link" href="{{ route('deconnexion') }}">
                                                        ...
                                                        {{ __('navigation.site_navbar_item_6_text') }}
                                                        </a>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="logo-right-content ml-auto">
                                <ul class="author-access-list">
                                    <li>
                                        <a href="{{ route('connexion') }}">{{ __('navigation.login_text') }}</a>
        ...
        <div class="side-nav-container">
            ...
            <div class="side-menu-wrap">
                <ul class="side-menu-ul">
                    @if(Auth::check())
                        <li>
                            <a href="{{ route('logged_profile') }}">{{ __('navigation.site_navbar_item_1_text') }}</a>
                        </li>
                        <li>
                            <a href="">{{ __('navigation.site_navbar_item_2_text') }}</a>
                        </li>
                        <li>
                            <a href="">{{ __('navigation.site_navbar_item_3_text') }}</a>
                        </li>
                        <li>
                            <a href="{{ route('notifications') }}">{{ __('navigation.site_navbar_item_4_text') }}</a>
                        </li>
                        <li>
                            <a href="">{{ __('navigation.site_navbar_item_5_text') }}</a>
                        </li>
                        <li>
                            <a href="{{ route('deconnexion') }}">{{ __('navigation.site_navbar_item_6_text') }}</a>
                        </li>
                    @else
                        <li>
                            <a href="{{ route('connexion') }}">{{ __('navigation.login_text') }}</a>
                        ...
                        <li>
                            <a href="">{{ __('navigation.become_teacher_text') }}</a>
                        </li>
                    @endif
                </ul>
            </div>
