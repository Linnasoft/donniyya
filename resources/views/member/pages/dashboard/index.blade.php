                    ...
                    <ul class="side-menu-ul">
                        <li class="page-active">
                            <a href="employer-dashboard.html">
                                <i class="fas fa-chart-pie icon-element"></i> Dashboard
                            </a>
                        </li>
                        <li>
                            <a href="employer-dashboard-message.html">
                                <i class="fa fa-envelope icon-element"></i> Messages 
                                <span class="badge badge-info radius-rounded p-1">3</span>
                            </a>
                        </li>
                        <li>
                            <a href="#">
                                <i class="fa fa-gear icon-element"></i> Settings 
                                <span class="fa fa-caret-down btn-toggle"></span>
                            </a>
                            <ul class="dropdown-menu-item">
                                <li><a href="employer-dashboard-edit-profile.html">Edit Profile</a></li>
                        ...
                        <li>
                            <a href="#">
                                <i class="fa fa-briefcase icon-element"></i> Jobs 
                                <span class="fa fa-caret-down btn-toggle"></span>
                            </a>
                            <ul class="dropdown-menu-item">
                        ...
                        <li>
                            <a href="employer-details.html">
                                <i class="fa fa-user icon-element"></i> View Profile
                            </a>
                        </li>
                        <li>
                            <a href="index.html">
                                <i class="fa fa-power-off icon-element"></i> Logout
                            </a>
                        </li>
                    </ul>
                </div>
